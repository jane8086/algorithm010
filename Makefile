...
INCPATH       = -I. -isystem /usr/local/include/opencv -isystem /usr/include/flycapture -isystem /usr/include/x86_64-linux-gnu/qt5 -isystem /usr/include/x86_64-linux-gnu/qt5/QtCore -I. -I/usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64
...
LINK          = g++
LFLAGS        = -m64
LIBS          = $(SUBLIBS) -L/usr/local/lib -lopencv_core -lopencv_imgcodecs -lopencv_highgui -lopencv_imgproc -lopencv_calib3d -lflycapture -lQt5Core -lpthread 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
DIST          = /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		...
		Phase_Shifting.pro headers/camera.h \
		headers/patterns.h \
		headers/phases.h src/main.cpp \
		src/camera.cpp \
		src/patterns.cpp \
		src/phases.cpp
...
distdir: FORCE
	...
	$(COPY_FILE) --parents headers/camera.h headers/patterns.h headers/phases.h $(DISTDIR)/
	$(COPY_FILE) --parents src/main.cpp src/camera.cpp src/patterns.cpp src/phases.cpp $(DISTDIR)/
...
main.o: src/main.cpp headers/camera.h \
		headers/patterns.h
